...
To get started you have to create a theory.
...
A Rubylog clauses swap the first argument with the functor. They can be created by calling a method. You have to declare the functor first:
  functor :likes
...
Solutions can be enumerated (Clause < Enumerable)
...
=== To the language
* Create a gist with the code sample.
